 ...
 * You may obtain a copy of the License audioTracker
 *
...
public final class Constants {
     ...
     * detections while improving battery life. A value of 0 results in activity detections audioTracker the
